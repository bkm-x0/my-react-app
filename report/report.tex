...
\part{Original Topic and Introduction}
\chapter*{Project Title}
\addcontentsline{toc}{chapter}{Project Title}
Design and Implementation of a Computer Hardware Sales Application
...
\begin{titlepage}
  \begin{center}
    ...
    % ---- Republic & Ministry header (Arabic + English) ----
    {\large\bfseries \arb{الجمهورية الجزائرية الديمقراطية الشعبية}}\\[0.1cm]
    {\large\bfseries People's Democratic Republic of Algeria}\\[0.2cm]
    {\large\bfseries \arb{وزارة التعليم العالي والبحث العلمي}}\\[0.1cm]
    {\large\bfseries Ministry of Higher Education and Scientific Research}\\[0.5cm]

    % ---- University logo ----
    \includegraphics[height=3cm]{university_logo.jpeg}\\[0.3cm]

    % ---- University / Faculty / Department (Arabic + English) ----
    {\large\bfseries \arb{جامعة عين تموشنت بلحاج بوشعيب}}\\[0.1cm]
    {\large\bfseries University --Ain Temouchent-- Belhadj Bouchaib}\\[0.15cm]
    {\normalsize\bfseries Faculty of Science and Technology}\\[0.1cm]
    {\normalsize\bfseries Department of Mathematics and Computer Science}\\[0.8cm]

    % ---- PFE heading ----
    {\LARGE\bfseries Final Year Graduation Project}\\[0.3cm]
    {\normalsize For obtaining the license degree}\\[0.15cm]
    {\normalsize Domain: Science and Technology}\\[0.1cm]
    {\normalsize Field: Mathematics and Computer Science}\\[0.1cm]
    {\normalsize Specialty: Computer Systems}\\[0.6cm]

    % ---- Theme ----
    {\large Theme}\\[0.4cm]

    % ---- Project title box ----
    \fbox{\parbox{12cm}{\centering\vspace{0.4cm}
      {\fontsize{22}{26}\selectfont\bfseries Design and Implementation of a Computer Hardware Sales Application}\\[0.2cm]
      {\Large\bfseries E-Commerce Platform}\\[0.1cm]
      {\normalsize Full-Stack Web Application}
    \vspace{0.4cm}}}
    ...
    \begin{minipage}[t]{0.45\textwidth}
      ...
      {\normalsize Kouider BENKRAMA}\\[0.1cm]
      {\normalsize Abderahim BAKHTI}\\[0.1cm]
      {\normalsize Mohamed BELHACEN}\\
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.45\textwidth}
      \raggedright
      {\large\bfseries Supervised by:}\\[0.3cm]
      {\normalsize Mr. BOUAFIA Zoheir}\\
    \end{minipage}
...
% ======================= PART 2: DIAGRAMS =======================
\part{System Diagrams}
% You can keep or move the following chapters as needed:
\chapter{System Design and Architecture}
\chapter{Database Design}
\chapter{API Design}

% ======================= PART 3: PROJECT SCREENSHOTS =======================
\part{Project Screenshots}
\chapter*{Screenshots}
\addcontentsline{toc}{chapter}{Screenshots}
% Insert screenshots of the main pages below:
\begin{figure}[H]
  \centering
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{screenshots/products.png}
