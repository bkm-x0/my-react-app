...
\definecolor{accent}{HTML}{17A589}
\definecolor{darkbg}{HTML}{1C2833}
\definecolor{codebg}{HTML}{F4F6F7}
\definecolor{codetext}{HTML}{2C3E50}
\definecolor{commentgreen}{HTML}{27AE60}
\definecolor{keywordblue}{HTML}{2874A6}
\definecolor{stringorange}{HTML}{CA6F1E}
\definecolor{tableheader}{HTML}{1A5276}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textcolor{primary}{\textbf{CyberStore} -- Final Project}}
...
\titleformat{\chapter}
  ...
  {\colorbox{primary}{\textcolor{white}{\;\chaptertitlename\ \thechapter\;}}}{10pt}{}
\titlespacing*{\chapter}{0pt}{10pt}{14pt}

% ======================== SECTION TITLE FORMAT ========================
\titleformat{\section}
  {\normalfont\Large\bfseries\color{primary}}
  {\textcolor{secondary}{\thesection}\quad}{0pt}{}
  [\vspace{2pt}{\color{secondary}\titlerule[1.5pt]}]

\titleformat{\subsection}
  {\normalfont\large\bfseries\color{secondary}}
  {\textcolor{accent}{\thesubsection}\quad}{0pt}{}
...
\begin{titlepage}
  \begin{center}
    ...
    % University header
    {\Large\textsc{\textcolor{primary}{University Name}}}\\[0.3cm]
    {\large\textcolor{secondary}{Faculty of Computer Science \& Information Technology}}\\[0.2cm]
    {\large\textcolor{secondary}{Department of Software Engineering}}\\[1.2cm]

    % Colored title block
    \begin{tikzpicture}
      \node[fill=primary, rounded corners=10pt, minimum width=14cm, minimum height=4.5cm, inner sep=0pt] (box) {};
      \node[text=white, font=\Huge\bfseries] at ([yshift=0.8cm]box.center) {CyberStore};
      \node[text=white!85, font=\LARGE] at ([yshift=-0.3cm]box.center) {Full-Stack E-Commerce Platform};
      \node[text=accent, font=\large\itshape] at ([yshift=-1.3cm]box.center) {A Modern Web Application for Gaming Hardware};
    \end{tikzpicture}

    \vspace{1.5cm}

    {\Large\textbf{\textcolor{primary}{Final Year Graduation Project Report}}}\\[0.5cm]
    {\large\textcolor{secondary}{Last Cycle -- Academic Year 2025/2026}}\\[2cm]

    % Author and supervisor boxes
    \begin{minipage}{0.42\textwidth}
      \begin{flushleft}
        \colorbox{tablerow}{\parbox{\dimexpr\linewidth-2\fboxsep}{\vspace{0.4cm}
        \textcolor{primary}{\textbf{Prepared by:}}\\[0.3cm]
        Student Name\\
    ...
    \begin{minipage}{0.42\textwidth}
      \begin{flushright}
        \colorbox{tablerow}{\parbox{\dimexpr\linewidth-2\fboxsep}{\vspace{0.4cm}
        \textcolor{primary}{\textbf{Supervised by:}}\\[0.3cm]
        Dr.~Supervisor Name\\
    ...
    \vfill
    {\color{primary}\rule{0.4\linewidth}{1pt}}\\[0.4cm]
