      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-white font-black text-2xl">Xush kelibsiz!</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              <label className="text-zinc-400 text-xs font-bold uppercase tracking-wider mb-2 block">Email</label>
            ...
            >
              <label className="text-zinc-400 text-xs font-bold uppercase tracking-wider mb-2 block">Parol</label>
              <div className="relative">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-zinc-400 text-sm">Meni eslab qol</span>
              </label>
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-zinc-500 text-xs">yoki</span>
            <div className="flex-1 h-px bg-zinc-800" />
          </div>

          {/* Demo login */}
          <motion.button
            onClick={() => { setEmail('demo@kpcstore.uz'); setPassword('demo123'); }}
